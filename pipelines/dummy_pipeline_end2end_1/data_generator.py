...
train_df = pd.DataFrame({
    ...
    "feat3": np.random.randint(0, 100, n_train),
    "feat4": np.random.rand(n_train) * 50,
    "feat5": np.random.randn(n_train),
    "label": np.random.randint(0, 2, n_train)  # binary target
})
...
test_df = pd.DataFrame({
    ...
    "feat3": np.random.randint(0, 100, n_test),
    "feat4": np.random.rand(n_test) * 50,
    "feat5": np.random.randn(n_test)
})
